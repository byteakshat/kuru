...
let intro = ["Hello, I am Kuru",  "Hello, My name is Kuru"];
...
let owner  = ['Akshat Mehta made me']
...
function chatbotvoice(message){
    ...
    speech.text = "This Message is not developed by Akshat paagal hain woe";
    ...
    if(message.includes('who made you')){
        let finalresult = owner[Math.floor(Math.random() * owner.length)];
        speech.text = finalresult;
    }
